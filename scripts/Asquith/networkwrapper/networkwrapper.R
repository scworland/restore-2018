...
H   <- read.table("data/all_huc12_covariates.csv", sep=",", header=TRUE,
...
GAG <- read.table("data/all_gage_covariates.csv", sep=",", header=TRUE,
                  colClasses="character")
STA <- read.table("data/all_gage_flow_stats.csv", sep=",", header=TRUE,
                  colClasses="character")
