...
message("PPLO (flowtime): coverage probability=", sprintf("%.2f", round(100*m/n,    digits=2)), " and ",
...
message("             T2: coverage probability=", sprintf("%.2f", round(100*m/n,    digits=2)), " and ",
                     "LOO coverage probability=", sprintf("%.2f", round(100*mloo/n, digits=2)))
...
message("             T3: coverage probability=", sprintf("%.2f", round(100*m/n,    digits=2)), " and ",
                     "LOO coverage probability=", sprintf("%.2f", round(100*mloo/n, digits=2)))
...
message("             T4: coverage probability=", sprintf("%.2f", round(100*m/n,    digits=2)), " and ",
                     "LOO coverage probability=", sprintf("%.2f", round(100*mloo/n, digits=2)))
...
message("             T5: coverage probability=", sprintf("%.2f", round(100*m/n,    digits=2)), " and ",
                     "LOO coverage probability=", sprintf("%.2f", round(100*mloo/n, digits=2)))
